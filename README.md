...
Обучение модели длилось 54 эпохи(*изначально было 100, но результаты не сохранились) . Полный код процесса обучения модели находится в корневой папке репозитория в файле pix2pix_gan.ipynb.
...
`
ssh -i `/mnt/c/Users/PC/Desktop/...../..../....pem  имя_ОС_ВМ@ip_адрес_ВМ`

Так вы попадете в окно терминала, но уже в ВМ

![2023-07-08_184510](https://github.com/Nasyhhhs/Pix2Pix-superRes-bot/assets/109277211/8adf9694-10c9-4002-992c-dd09657baed2)
...
Данный бот не является конечным и будет дорабатываться по мере моих сил и энтузиазма. Некоторые пометки делаю в файле todo текущего репозитория. Возможно в скором времени будет обучен на большем количестве эпох и датасете лучшего качества. Также возможно будут добавлены новые функции и возможности работы с изображениями. 
